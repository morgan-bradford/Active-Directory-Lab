...
<img src="https://imgur.com/MsOWxch.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Open VirtualBox and select new. <br/>
<img src="https://imgur.com/XLgm6hV.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Name your Virtual Machine DC. <br/>
Select Other Windows 64-bit for the version, then hit next. <br/>
<img src="https://imgur.com/H6DsLsN.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<img src="https://imgur.com/oo9OxE3.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Change oyur hardware suitable to your PC setup, hit next. <br/>
<img src="https://imgur.com/F5Ewp6V.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Hit Next. <br/>
Finish. <br/>
<img src="https://imgur.com/RTco81s.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<img src="https://imgur.com/m7ZKeFk.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
While the new virtual machine is highlighted hit Settings. <br/>
<img src="https://imgur.com/V5zlxxk.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
</p>
In General click the Advanced Tab. <br/>
Change Shared Clipboard and Drag'n'Drop to bidirectional. <br/>
<img src="https://i.imgur.com/nCIbXbg.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Click the Network tab. <br/>
Click Adapter 2. Enable it and change Attached to: to Internal network. <br/>
Then click Ok:  <br/>
<img src="https://i.imgur.com/cdFHBiU.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="https://i.imgur.com/JL945Ga.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Click Next:  <br/>
<img src="https://i.imgur.com/K71yaM2.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
<br />
<br />
Click CUstom: Install Widnows only (advanced)  <br/>
<img src="https://i.imgur.com/AeZkvFQ.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
</p>
Click Next. <br/>
Allow to install. <br/>
<img src="https://i.imgur.com/nCIbXbg.png" height="60%" width="60%" alt="Disk Sanitization Steps"/>
